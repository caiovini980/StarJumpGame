...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (!_isDead && transform.position.y < _deathPoint.transform.position.y - 5f)
        {
            _isDead = true;
    ...
    {
        _animator.Play(JUMP_ANIM_NAME, -1, 0);
        _animator.Play(JUMP_ANIM_NAME);
    }

    public void PlayParticleSystemAt(Vector3 position)
    {
