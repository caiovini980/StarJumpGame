...
[CreateAssetMenu(fileName = "Shake Transform Event", menuName = "Events/Shake Transform Event", order = 1)]
public class ShakeTransformEventData : ScriptableObject
{
    ...
    public float amplitude = 1.0f; //range of motion of the target action
    public float frequency = 1.0f; //speed of the action
    public float duration = 1.0f; //how long the action will last
